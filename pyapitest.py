...
results = model.predict(source="/home/nkozlitin/cvdatastore/VideoArchive/MainData/LeftObjects/certification/AO_LO_2_TOP.avi", save_txt=False, stream=True, save_frames=False, save=False, show_boxes=False)
...
for index,result in enumerate(results):
    ...
    im = Image.fromarray(result.orig_img, mode="RGB")
